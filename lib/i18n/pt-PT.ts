...
export const ptPT: typeof en = {
  ...
  notificationsScreen: {
    ...
    sentence: {
      ...
      sittingGraceDayWater: "Dia de tolerância concedido: a rega de {plant} foi prorrogada por 1 dia — conclua-a até amanhã",
      sittingGraceDayFertilize: "Dia de tolerância concedido: a adubação de {plant} foi prorrogada por 1 dia — conclua-a até amanhã",
      sittingGraceDayRepot: "Dia de tolerância concedido: a troca de terra de {plant} foi prorrogada por 1 dia — conclua-a até amanhã",
